...
def load_data(datapath):
    text_path = os.path.join(datapath, 'transfer.data.xml')
    gold_path = os.path.join(datapath, 'transfer.gold.key.txt')
    ...
    outfile = os.path.join(datapath, 'transfer.csv')
...
if __name__ == "__main__":
    ...
    # split in ['./mulan-de', './mulan-fr', './mulan-it', './mulan-es']
    data_path = './mulan-de'
